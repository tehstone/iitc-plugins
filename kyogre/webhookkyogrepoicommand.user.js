...
function wrapper(plugin_info) {
  ...
  thisPlugin.showSettingsDialog = function () {
    const html = `<p><label for="textBotName">Bot Display Name</label><br><input type="text" id="textBotName" size="20" /></p>
  ...
  window.plugin.SendToWebhook.addButton = function () {
    $(".linkdetails").append(
      '<aside><a href="#" onclick="window.plugin.SendToWebhook.convertToGymCommand()">Convert to Gym Command</a></aside>'
    );
    $(".linkdetails").append(
      '<aside><a href="#" onclick="window.plugin.SendToWebhook.createGymCommand()">Create Gym Command</a></aside>'
    );
    $(".linkdetails").append(
      '<aside><a href="#" onclick="window.plugin.SendToWebhook.createStopCommand()">Create PokeStop Command</a></aside>'
    );
  };
  ...
  window.plugin.SendToWebhook.convertToGymCommand = function () {
    ...
    const commandMessageText = "!loc convert " + p_name;
  ...
  const chooseNewLabel = function () {
    const promptAction = prompt("Select the region this POI is in");
